...
export async function getBridgeQuote(
  ...
  const queryParams = new URLSearchParams({
    ...
    ...params.srcIntermediaryTokenAddress && { srcIntermediaryTokenAddress: params.srcIntermediaryTokenAddress },
    ...params.dstIntermediaryTokenAddress && { dstIntermediaryTokenAddress: params.dstIntermediaryTokenAddress },
    ...params.dstIntermediaryTokenSpenderAddress && { dstIntermediaryTokenSpenderAddress: params.dstIntermediaryTokenSpenderAddress },
    ...params.intermediaryTokenUSDPrice && { intermediaryTokenUSDPrice: params.intermediaryTokenUSDPrice.toString() },
    ...params.srcAllowedCancelBeneficiary && { srcAllowedCancelBeneficiary: params.srcAllowedCancelBeneficiary },
    ...params.referralCode && { referralCode: params.referralCode.toString() },
    ...params.affiliateFeePercent && { affiliateFeePercent: params.affiliateFeePercent.toString() }
  });
  ...
  if (!response.ok) {
    ...
    throw new Error(`Failed to get bridge quote: ${response.status} - ${errorText}`);
  }
